...
\begin{itemize}
  ...
  \item         Propaganda methods: using disgusting things (e.g., child pornography) to advocate censorship tools.\index{Propaganda}
\end{itemize}
...
\nomenclature{DRM}{Digital Restrictions Management / Digital Rights Management}
...
\begin{itemize}
 ...
 \item    Real-life examples: Amazon Swindle, portable phones. \index{Swindle}
\end{itemize}
...
\begin{itemize}
 ...
 \item        Propaganda. Terms like "Piracy" and "Theft":\index{Sharing}\index{Piracy}
 ...
 \nomenclature{DVD}{Digital Versatile Disc}
 \item        DMCA: Digital Millennium Copyright Act: \index{Threats!DMCA}
\nomenclature{DMCA}{Digital Millennium Copyright Act}
\begin{itemize}
...
\begin{itemize}
 ...
 \nomenclature{AACS}{Advanced Access Content System}
...
\begin{itemize}
 \item        You need to cooperate with ISP, DNS registrar, other companies in order to do your tasks.\index{ISP}
...
\nomenclature{DNS}{Domain Name System}
 ...
 \item        Example: Dirty Tricks campaign against WikiLeaks.\index{WikiLeaks}
...
\begin{itemize}
\item    Why does a free program have a license?\index{Licenses}
\begin{itemize}
...
\begin{itemize}
 \item            The problem is real. E.g., TeX. Its UNIX implementation was made non free while original Knuth's implementation was free (but distributed under non copyleft license).\index{Software!TeX@\TeX}
...
\nomenclature{AGPL}{GNU Affero General Public License}
...
\begin{itemize}
 \item     What is wrong with Amazon ''Swindle''?\index{Swindle}
...
\begin{itemize}
 \item    Four reasons to use free software in education:\index{Education}
\begin{enumerate}
...
\end{itemize}
 \item    GNU LibreJS: Free JavaScript in your browser:\index{JavaScript}\index{Software!LibreJS}
...
\begin{itemize}
 ...
 \end{itemize}
 \item    Reject propaganda terms: \index{Propaganda}
 \begin{itemize}
 ...
 \item    Learn how to make easy changes: \index{Four Freedoms}
 \begin{itemize}
...
%% We don't need \chapter to be issues. Redefined nomenclature environment
\makeatletter
\def\thenomenclature{%
  \nompreamble
  \list{}{%
